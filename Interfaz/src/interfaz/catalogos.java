    ...
    private void CatalogoExeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CatalogoExeButtonActionPerformed
        ...
        if (CatalogsCB.getSelectedItem().equals("Author")){
            if(CatalogsActionCB.getSelectedItem().equals("Insert")){
                try {
                    connect.connectdbp.InsertAuthor(CatalogDescriptionTF.getText());
                ...
                try {
                    connect.connectdbp.UpdateAuthor(Integer.parseInt(CatalogIdTextField.getText()), CatalogDescriptionTF.getText());
                } catch (SQLException ex) {
                    Logger.getLogger(catalogos.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
                ...
                try {
                    connect.connectdbp.DeleteAuthor(Integer.parseInt(CatalogIdTextField.getText()));
                } catch (SQLException ex) {
                    Logger.getLogger(catalogos.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
